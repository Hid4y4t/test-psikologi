            ...
            <form class="subsoal col-md-6">
                <fieldset class="section is-active">
                    ...
                    <div class="soal">
                        ...
                        <br>
                        <!-- =================== -->
                        <input type="radio" name="soal1" value="1" id="rb2" />
                    ...
                    <div class="soal">
                        ...
                        <br>
                        <!-- ======================== -->
                        <input type="radio" name="soal2" value="1" id="rb7" />
                    ...
                    <div class="soal">
                        ...
                        <br>
                        <!-- =================== -->
                        <input type="radio" name="soal4" value="1" id="rb18" />
                    ...
                    <div class="soal">
                        ...
                        <br>
                        <!-- =================== -->
                        <input type="radio" name="soal8" value="1" id="rb39" />
                    ...
                    <div class="soal">
                        ...
                        <br>
                        <!-- =================== -->
                        <input type="radio" name="soal9" value="1" id="rb44" />
                    ...
                    <div class="soal">
                        ...
                        <h6>33. </h6>
                        <input type="radio" name="soal13" value="1" id="rb61" />
