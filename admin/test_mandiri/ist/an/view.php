...
$query = mysqli_query($koneksi, "SELECT * FROM soal_an WHERE id='$id'");
...
<body>
    ...
    <body>
        <center>
           <div class="header" style="color: blanchedalmond;">
           <h2>HASIL TEST IST <br> <span style="font-style:italic; font-weight: bold; color: red;" >AN</span> </h2>
           <p>ID TEST: <?php echo $id ?></i>
           </div> </p> <br><br>
