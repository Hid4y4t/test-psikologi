...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="../../user_mandiri/tambah_user.php">Tambah User Mandiri</a>
            ...
            <a class="collapse-item" href="../../user_kelompok/tambah_user.php">Tambah User Kelompok</a>
