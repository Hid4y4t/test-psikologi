            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        $data_user = mysqli_query($koneksi, "SELECT * FROM user_mandiri");


                        $jumlah_user = mysqli_num_rows($data_user);
                        ?>
                        <!-- User Mandiri Card Example -->
                        ...
                        $data_user_k = mysqli_query($koneksi, "SELECT * FROM user_kelompok");


                        $jumlah_user_k = mysqli_num_rows($data_user_k);
                        ?>
                        <!-- User Kelompok Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                User Kelompok</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_user_k; ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $jumlah_artikel; ?></div>
                                                </div>
                        ...
                        $data_kelompok = mysqli_query($koneksi, "SELECT * FROM kelompok");


                        $jumlah_kelompok = mysqli_num_rows($data_kelompok);
                        ?>
                        <!-- Kelompok Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Kelompok</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_kelompok; ?></div>
                                        </div>
                                        <div class="col-auto">
