                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Edit User <br> Kelompok</h1>
                            </div>

                            <?php
                            include '../../koneksi/koneksi.php';
                            $id_user_k = $_GET['id_user_k'];
                            $data = mysqli_query($koneksi, "select * from user_kelompok where id_user_k='$id_user_k'");
                                ...
                                <form class="user" name="pgenerate" method="post" action="aksi_edit.php">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="hidden" name="id_user_k" value="<?php echo $d['id_user_k']; ?>">
                                            <input type="text" name="nama_user_k" class="form-control form-control-user" id="exampleFirstName" value="<?php echo $d['nama_user_k']; ?>">
                                        </div>


                                        <div class="col-sm-6">
                                            <input type="text" name="username_user_k" class="form-control form-control-user" id="exampleLastName" value="<?php echo $d['username_user_k']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" readonly placeholder="password" size=18 name="psd_user"> <b>Panjang Password:</b> <input type="text" class="form-control form-control-user" name="thelength" size=3 value="8">
                                        <br>
                                        <center>
