            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="my-4 text-center">
                        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">KELOMPOK TEST IST KELOMPOK</h1>
                        <p class="mt-2 text-gray-600">Selamat datang di halaman kelompok test IST Kelompok. Silakan pilih salah satu tes di bawah ini.</p>
                    </div>
