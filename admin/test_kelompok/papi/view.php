...
$query = mysqli_query($koneksi, "SELECT * FROM test_papi_k WHERE id='$id'");
...
<body>
    ...
    <body>
        <center>
            <h2>HASIL TEST PAPI </h2>
            <p><i>Perception And Preference Inventory<br>ID Jawaban: <?php echo $id ?> ID Kelompok : <?php echo $data['id_kelompok']; ?></i> <br><br>
            ...
            <table border="1" cellpadding="7">
                ...
                <tr>
                    ...
                    <td size="90">71.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal71']; ?></td>
                    <td size="90">81.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal82']; ?></td>
                ...
                <tr>
                    ...
                    <td size="90">73.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal73']; ?></td>
                    <td size="90">83.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal83']; ?></td>
                ...
                <tr>
                    ...
                    <td size="90">74.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal74']; ?></td>
                    <td size="90">84.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal84']; ?></td>
                ...
                <tr>
                    ...
                    <td size="90">65.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal65']; ?></td>
                    <td size="90">75.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal75']; ?></td>
                    <td size="90">85.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal85']; ?></td>
                </tr>
                <tr>
                    <td>6.</td>
                    ...
                    <td size="90">66.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal66']; ?></td>
                    <td size="90">76.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal76']; ?></td>
                    <td size="90">86.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal86']; ?></td>
                </tr>
                <tr>
                    <td> 7.</td>
                    ...
                    <td size="90">67.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal67']; ?></td>
                    <td size="90">77.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal1']; ?></td>
                    <td size="90">87.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal87']; ?></td>
                </tr>
                <tr>
                    <td>8.</td>
                    ...
                    <td size="90">68.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal68']; ?></td>
                    <td size="90">78.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal78']; ?></td>
                    <td size="90">88.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal88']; ?></td>
                </tr>
                <tr>
                    <td> 9.</td>
                    ...
                    <td size="90">69.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal69']; ?></td>
                    <td size="90">79.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal79']; ?></td>
                    <td size="90">89.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal89']; ?></td>
                </tr>
                <tr>
                    <td>10.</td>
                    ...
                    <td size="90">70.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal70']; ?></td>
                    <td size="90">80.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal80']; ?></td>
                    <td size="90">90.</td>
                    <td>&nbsp;&nbsp;<?php echo $data['soal90']; ?></td>
                </tr>
