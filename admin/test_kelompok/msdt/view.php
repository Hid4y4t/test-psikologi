...
$query = mysqli_query($koneksi, "SELECT * FROM test_msdt_k WHERE id='$id'");
...
<body>
    ...
    <body>
        <center>
            ...
            <p><i>Management Style Diagnostic Test <br>ID Jawaban: <?php echo $id ?> ID Kelompok : <?php echo $data['id_kelompok']; ?>  </i> </p> <br><br>
