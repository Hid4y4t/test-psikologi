  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        ...
        <li><a href="../login/index.php" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Login</span></a>
        </li>
      </ul>
    </nav><!-- .nav-menu -->
    ...
    <nav id="mobile2" class="navbar2 fixed-bottom">
      <div class="menu-bawah">
        <ul>
          ...
          <li><a href="../artikel.php"><img src="img/form.png" alt="">Artikel</a></li>
          <li><a href="../index.php"> <img src="img/customer-service.png" alt="">Contact</a></li>
  ...
  <section id="contact" class="contact">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row mt-1">
        ...
        <h3 class="title">Perlu Bantuan? silahkan Hubungi Nuha Solution!</h3>
        <p class="text">
          Hubungi Nuha Soltion dengan media whatsapp atau telpon. <br>Anda juga bisa datang
          langsung ke Lokasi Nuha Solution <br><br><br>
        </p>
        ...
        <div class="col-lg-4">
          <div class="info">
            <div class="address">
              ...
              <h4>Location:</h4>
              <p>Jl. Sidomukti Tim. No.1, no.8, Pajang, Kec. Laweyan, Kota Surakarta, Jawa Tengah 57146</p>
            </div>

            <div class="email">
              <a href="mailto:solutionnuha@gmail.com">
                <i class="bi bi-envelope"></i></a>
              <h4>Email:</h4>
              <p>solutionnuha@gmail.com</p>
            </div>
            ...
            <div class="phone">
              <a href="https://wa.me/6285647200576">
      ...
      <div class="Contact col-md-12">
        <div class="row">
          ...
          <div class="maps-responsive col-md-4">
            <h5>Location</h5>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.0333882885384!2d110.78259861477682!3d-7.571338894539952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a1563c0d87a87%3A0xae8d66581da2ac20!2sjasa%20psikologi%20solo%20nuha%20solution!5e0!3m2!1sid!2sid!4v1657004045425!5m2!1sid!2sid"
